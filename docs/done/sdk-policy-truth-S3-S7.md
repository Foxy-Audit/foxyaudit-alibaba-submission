> **ARCHIVED 2026-08-24.** Every phase below shipped: S3 as 1.6.0, S4 as 1.7.0,
> S5 as 1.8.0, S6 in the desktop, S7 partially (its listing tail was carried into
> S16). Kept for the reasoning and the traps, not as live work. The successor is
> `docs/plans/sdk-policy-truth.md` (S12-S16).
