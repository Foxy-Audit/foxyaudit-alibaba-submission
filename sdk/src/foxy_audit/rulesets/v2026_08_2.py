"""FROZEN ruleset 2026.08.2. Generated once from describe_live(); NEVER EDIT.
...
Supersedes 2026.08.1, which remains in the registry forever because rows name it.
The only difference is that response_rules now carries a `coverage` family:
2026.08.1 could not explain the `response_scan.degraded` / `.unreadable` ids that
rows stamped with it already carried.

sha256 over canonical JSON: 59888ec66b3e2b84f550412ec5f2372e9d90f4a8df66a9e5ad9193f7c17b1f62
"""
